  ...
  <div class="modal-dialog modal-lg" id="5">
    <div class="modal-content">
      ...
      <div class="row text-center mt-4">
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
          <img class="card-img-top" src="{{$program->img }}"  height="180" alt="Card image cap" data-toggle="modal"  href="#4">
            <div class="modal fade bd-example-modal-lg" id="4" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" id="4">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{"$program->prog_name"}}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
